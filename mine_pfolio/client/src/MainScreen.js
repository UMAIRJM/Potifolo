...
import BasicExample1 from './components/Spinner';
...
<div className='inTouch' id='intouch'>
    ...
    <div className='intouchDiv'>
        <div className='inputFieldsAlign'>
            <BasicTextFields  className='inputChild' labeel={'First name'} userInput={firstName} setUserInput={setFirstName}/>
            <BasicTextFields labeel={'Last Name'} className='inputChild' userInput={lastName} setUserInput={setLastName}/>
            
        </div>
        <div className='inputFieldsAlign'>
        <BasicTextFields labeel={'Email'} className='inputChild'userInput={email} setUserInput={setEmail}/>
        <BasicTextFields labeel={'Phone'} className='inputChild' userInput={number} setUserInput={setNumber}/>
        </div>
        <BasicTextFields labeel={'Message'} className='messgaeInput' userInput={message} setUserInput={setMessage}/>
        {flagg ? (
    <p style={{color:'red'}}>Message is required</p>
):<p></p>}
{majorError? <p style={{color:'red'}}>Error Sending Message </p>:<p></p>}
{isLoading ? <BasicExample1/>:<p></p>}
        <Button variant="dark" type='submit' style={{width:'50%',marginLeft:'50%', transform: 'translateX(-50%)'}} onClick={submitButtonHandler}>Send</Button>
